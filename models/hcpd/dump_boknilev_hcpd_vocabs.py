...
def build_vocabs():
    ...
    verb_ss_vocab = Vocabulary('VERB_SS')
    verb_ss_vocab.add_words(set([hc.verb_ss for s in samples for hc in s.x.head_cands]))
    verb_ss_vocab.add_word(None)

    noun_ss_vocab = Vocabulary('NOUN_SS')
    noun_ss_vocab.add_words(set([hc.noun_ss for s in samples for hc in s.x.head_cands]))
    noun_ss_vocab.add_word(None)
    ...
    return [gold_pos_vocab, words_vocab, verb_ss_vocab, noun_ss_vocab, words_to_lemmas]
