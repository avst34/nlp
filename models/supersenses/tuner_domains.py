...
TUNER_DOMAINS_TUNING = [
    ...
    PS(name='use_capitalized_word_follows', values=[True, False]),
    PS(name='update_lemmas_embd', values=[True, False]),
    PS(name='use_token_internal', values=[True, False]),
    PS(name='use_ud_xpos', values=[True, False]),
    PS(name='use_ud_dep', values=[True, False]),
    PS(name='use_ner', values=[True, False]),
    PS(name='use_govobj', values=[True, False]),
    ...
    PS(name='use_lexcat', values=[True, False]),
    ...
    PS(name='mlp_layers', values=[0,1,2,3]),
    ...
    PS(name='num_lstm_layers', values=[0,1,2,3]),
    PS(name='is_bilstm', values=[True, False]),
