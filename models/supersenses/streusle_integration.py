...
def streusle_record_to_lstm_model_sample(record):
    return LstmMlpSupersensesModel.Sample(
        xs=[LstmMlpSupersensesModel.SampleX(
            ...
            coremlp_pos=tagged_token.coremlp_pos,
            coremlp_dep=tagged_token.coremlp_dep,
            coremlp_head_ind=tagged_token.coremlp_head_ind,
            coremlp_ner=tagged_token.coremlp_ner,
            coremlp_lemma=tagged_token.coremlp_lemma,
