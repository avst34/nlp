...
GOV_OBJ_ROLE = override_settings([TUNER_DOMAINS, [
    PS(name='labels_to_predict', values=[('supersense_role',)]),
    PS(name='use_gov', values=[True]),
    PS(name='use_obj', values=[True]),
    PS(name='use_prep', values=[False]),
...
PREP_ROLE_FUNC = override_settings([TUNER_DOMAINS, [
    PS(name='labels_to_predict', values=[('supersense_func',)]),
    PS(name='use_gov', values=[False]),
    PS(name='use_obj', values=[False]),
    PS(name='use_prep', values=[True]),
...
PREP_FUNC_ROLE = override_settings([TUNER_DOMAINS, [
    PS(name='labels_to_predict', values=[('supersense_role',)]),
    PS(name='use_gov', values=[False]),
    PS(name='use_obj', values=[False]),
    PS(name='use_prep', values=[True]),
...
TASK_SETTINGS = {
    ...
    'prep.func': PREP_FUNC,
    'prep.role': PREP_ROLE,
    'prep.role.func': PREP_ROLE_FUNC,
    'prep.func.role': PREP_ROLE_FUNC
}