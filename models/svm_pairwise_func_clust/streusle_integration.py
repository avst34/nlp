...
def streusle_records_to_svm_pairwise_func_clust_model_samples(recs):
    nodes = []
    for rec in recs:
    ...
    for node1, node2 in itertools.combinations(nodes, 2):
        samples.append(SvmPairwiseFuncClustModel.Sample(
            x=SvmPairwiseFuncClustModel.SampleX(
            ...
            y=SvmPairwiseFuncClustModel.SampleY(
                is_same_cluster=node1['supersense_func'] == node2['supersense_func']
            ),
