...
from datasets.streusle_v4.build_predictions_list import build_predictions_list, dump_predictions
...
def run():
  ...
  "labels_to_predict": [
    ...
    evaluate_model_on_task('goldid.goldsyn', model, streusle_record_to_lstm_model_sample, '/tmp/role_only', save_model=True)
    ...
    dump_predictions(preds, '/tmp/role_only/preds.json')
