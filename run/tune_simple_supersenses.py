...
from models.supersenses_simple.settings import GOV_FUNC, OBJ_FUNC, OBJ_ROLE, GOV_ROLE, PREP_FUNC, PREP_ROLE, \
    GOV_OBJ_FUNC, GOV_OBJ_ROLE
...
train_recs = StreusleLoader(load_elmo=True).load_train()
dev_recs = StreusleLoader(load_elmo=True).load_dev()
